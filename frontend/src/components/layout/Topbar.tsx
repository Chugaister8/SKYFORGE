...
export function Topbar() {
  ...
  return (
    <header className="
      ...
      px-4 border-b border-border-dim
      bg-bg-surface shrink-0 z-50
    ">
      {/* Left — Logo */}
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <span className="font-mono text-2xs text-threat-low tracking-widest">
            SYS NOMINAL
          </span>
        </div>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-2">
          <div className="text-right hidden sm:block">
            ...
            <p className={`font-mono text-2xs leading-none mt-0.5 ${roleColor}`}>
              {user?.role ?? "—"}
            </p>
          </div>
          <div className="
            w-7 h-7 rounded flex items-center justify-center
            bg-cyan-subtle border border-border-dim
            font-mono text-xs text-cyan-DEFAULT font-medium
          ">
